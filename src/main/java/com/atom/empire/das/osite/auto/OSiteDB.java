...
public class OSiteDB extends DBDatabase {
	...
	public final T_CfgCopy T_CFG_COPY = new T_CfgCopy(this);
	public final T_Ctg T_CTG = new T_Ctg(this);
	public final T_CtgCopy T_CTG_COPY = new T_CtgCopy(this);
  ...
  public static class T_CfgCopy extends OSiteTable {
	...
	public T_CfgCopy(OSiteDB db) {
		super("jee_cfg_copy", db);
		
		// create columns
		C_CATG = addColumn("catg", DataType.TEXT, 64.0, true, "");
		C_NAME = addColumn("name", DataType.TEXT, 64.0, true, "");
		C_TITLE = addColumn("title", DataType.TEXT, 128.0, false, null);
		C_VALUE = addColumn("value", DataType.TEXT, 1024.0, false, null);
		C_VALUE_EXT = addColumn("value_ext", DataType.CLOB, 65535.0, false, null);
		C_NEW_TIME = addColumn("new_time", DataType.TEXT, 32.0, false, null);
		C_UPD_TIME = addColumn("upd_time", DataType.TEXT, 32.0, false, null);
  ...
  public static class T_CtgCopy extends OSiteTable {
	...
	public T_CtgCopy(OSiteDB db) {
		super("jee_ctg_copy", db);
		
		// create columns
		C_NO = addColumn("no", DataType.TEXT, 64.0, true, "");
		C_CTG = addColumn("ctg", DataType.TEXT, 64.0, false, null);
		C_FLAG = addColumn("flag", DataType.TEXT, 128.0, false, null);
		C_SORT = addColumn("sort", DataType.TEXT, 16.0, false, null);
		C_TITLE = addColumn("title", DataType.TEXT, 256.0, false, null);
