...
public class CfgTB extends OSiteTable {
	...
	public CfgTB(OSiteDB db) {
		super("jee_cfg", db);
		
		// create columns
		CATG = addColumn("catg", DataType.TEXT, 64.0, true, null);
		NAME = addColumn("name", DataType.TEXT, 64.0, true, null);
		TITLE = addColumn("title", DataType.TEXT, 128.0, false, null);
		VALUE = addColumn("value", DataType.TEXT, 1024.0, false, null);
		VALUE_EXT = addColumn("value_ext", DataType.CLOB, 2.147483647E9, false, null);
